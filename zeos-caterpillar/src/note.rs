...
impl NoteEx
{
    ...
    {
        let remainder = self.leaf_idx_arr % MT_ARR_FULL_TREE_OFFSET!(MERKLE_TREE_DEPTH);
        let offset = MT_ARR_LEAF_ROW_OFFSET!(MERKLE_TREE_DEPTH);
        remainder.saturating_sub(offset)
    }
