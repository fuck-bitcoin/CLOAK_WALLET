...
class NativeLibrary {
  ...
  late final _warp_asyncPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Uint8, ffi.Uint32, bool, ffi.Uint32,
              ffi.Uint32, ffi.Int64)>>('warp_async');
  late final _warp_async =
      _warp_asyncPtr.asFunction<void Function(int, int, int, int, int, int)>();
  ...
  CResult_u8 check_account_activity(
    int coin,
    ffi.Pointer<ffi.Char> seed,
    int account_index,
  ) {
    return _check_account_activity(
      coin,
      seed,
      account_index,
    );
  ...
  late final _check_account_activityPtr =
      _lookup<ffi.NativeFunction<CResult_u8 Function(ffi.Uint8, ffi.Pointer<ffi.Char>, ffi.Uint32)>>(
          'check_account_activity');
  late final _check_account_activity =
      _check_account_activityPtr.asFunction<CResult_u8 Function(int, ffi.Pointer<ffi.Char>, int)>();

  CResult_u32 scan_shielded_accounts(
    int coin,
    ffi.Pointer<ffi.Char> seed,
    int max_index,
    int num_blocks,
  ) {
    return _scan_shielded_accounts(
      coin,
      seed,
      max_index,
      num_blocks,
  ...
  late final _scan_shielded_accountsPtr =
      _lookup<ffi.NativeFunction<CResult_u32 Function(ffi.Uint8, ffi.Pointer<ffi.Char>, ffi.Uint32, ffi.Uint32)>>(
          'scan_shielded_accounts');
  late final _scan_shielded_accounts =
      _scan_shielded_accountsPtr.asFunction<CResult_u32 Function(int, ffi.Pointer<ffi.Char>, int, int)>();

  CResult_____c_char derive_fvk_for_index(
    int coin,
    ffi.Pointer<ffi.Char> seed,
    int index,
  ) {
    return _derive_fvk_for_index(coin, seed, index);
  }
  late final _derive_fvk_for_indexPtr =
      _lookup<ffi.NativeFunction<CResult_____c_char Function(ffi.Uint8, ffi.Pointer<ffi.Char>, ffi.Uint32)>>(
          'derive_fvk_for_index');
  late final _derive_fvk_for_index =
      _derive_fvk_for_indexPtr.asFunction<CResult_____c_char Function(int, ffi.Pointer<ffi.Char>, int)>();
