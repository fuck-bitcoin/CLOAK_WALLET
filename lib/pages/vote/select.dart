...
class VoteSelectState extends State<VoteSelect> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _checkMigrationAndShowTutorial();
    });
  }

  void _checkMigrationAndShowTutorial() async {
    // Check if funds need to be migrated to Orchard for voting
    if (needsOrchardMigration()) {
      await showMigrationModalIfNeeded(context);
    }
